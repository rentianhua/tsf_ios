...
-(void)transitionPhotoVC{
    ...
    [_handleVC.navigationController.view.layer transitionWithAnimType:TransitionAnimTypeReveal subType:TransitionSubtypesFromLeft curve:TransitionCurveDefault duration:.8f];
}
...
-(void)dismiss{
    ...
    switch (_type) {
        ...
        case PhotoBroswerVCTypeTransition://transition
            ...
            [_handleVC.navigationController.view.layer transitionWithAnimType:TransitionAnimTypeReveal subType:TransitionSubtypesFromRight curve:TransitionCurveDefault duration:.8f];
