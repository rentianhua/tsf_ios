...
@interface TSFLouCengView ()<UIPickerViewDelegate,UIPickerViewDataSource>{
    UIView * _BJView;
...
- (instancetype)initWithFrame:(CGRect)frame selectTitle:(NSString *)title allArray:(NSArray *)array{
    if (self=[super initWithFrame:frame]) {
        ...
        [_pickView selectRow:_secondIndex inComponent:0 animated:YES];
...
-(void)rightBTN{
    ...
    if (self.selectBlock) {
        self.selectBlock(_array[0][_firstIndex],_array[1][_secondIndex]);
    }
